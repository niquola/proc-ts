export default async function http_ui_issues_$id(ctx: Ctx, session: Session, request: Req) {
  ...
  if (request.method === "GET") {
    ...
    const comments = db_query(ctx, "SELECT * FROM comments WHERE issue_id = ? ORDER BY created_at ASC", [id]);
